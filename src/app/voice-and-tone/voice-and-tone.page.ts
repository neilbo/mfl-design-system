  ...
  principles: Principle[] = [
    {
      ...
      message: `Think of families and the love and care they share. It's warm and genuine. This is the same feeling services want to portray to their families. Talk about My Family Lounge as though you're speaking of your family and the great benefits they have. Tread lightly when expressing views from a "business" and "centre" standpoint.`,
      img: `/assets/images/undraw_play_time_7k7b.svg`
    },
    {
      title: `Connecting and conversational`,
      message: `The parent portal does bridge a agap between services, children and families throughout the day (especially seeing children's learning and photos) but it does not replace parent-educator conversations, and it shouldn't. Be clear on the features it has and the features that it doesn't, and the decisions why. E.g. If a parent sees an incident report before having a converstation with the Educator it could cause more panic than resolution.`,
      img: `/assets/images/undraw_begin_chat_c6pj.svg`
    },
    {
      title: `Sharing, not annoying`,
      message: `Families can share in their child's learning journey without making the child care workers feel obliged to interact with parents online. It acts as inspiration to to initiate conversation`,
